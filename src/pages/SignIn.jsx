...
const SignIn = () => {
  ...
  return (
    <div>
      <div className="flex flex-col gap-4 items-center w-full h-[500px] sm:h-fit sm:flex-row  sm:bg-[linear-gradient(rgba(185,156,203,1),rgba(174,133,204,1),rgba(138,99,162,1))] relative">
        <img
        ...
        />
        <form className="flex flex-col w-full items-center   md:w-[367px]  xl:w-[967px] gap-4 absolute bottom-2 sm:static" onSubmit={handleSubmit()}>
          ...
          <div className="w-[98%] h-fit rounded bg-white flex flex-col gap-1 xl:gap-3 p-2 xl:p-10 md:w-[367px] xl:w-[467px]">
            <button className="rounded-lg px-5 py-2 border-solid border-[1px] border-[rgba(236, 236, 236, 1)] text-[.8rem] sm:text-[.7rem] xl:text-[1rem] font-bold ease-in-out duration-300 hover:scale-[1.02]">
            ...
            <input
              type="email"
              className="rounded-2xl px-5 py-2 border-solid border-[1px] border-[rgba(236, 236, 236, 1)] text-[.8rem] sm:text-[.7rem] xl:text-[1rem] focus:outline-none"
            />
            <input
              type="password"
              className="rounded-2xl px-5 py-2 border-solid border-[1px] border-[rgba(236, 236, 236, 1)] text-[.8rem] sm:text-[.7rem] xl:text-[1rem] focus:outline-none"
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="toggleCheckbox" className="mb-1 text-[.8rem] sm:text-[.7rem] xl:text-[1rem]">
                დამახსოვრება
              </label>
            </div>
            ...
            <button className="bg-buttonColor-primary rounded-2xl text-white py-[6px] text-[.8rem] sm:text-[.7rem] xl:text-[1rem]">ავტორიზაცია</button>
          </div>
        </form>
      </div>
    </div>
