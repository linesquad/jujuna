function HeroContent({
  ...
  title = "",
  titleStyle = "text-color-primary text-[48px] font-tommaso lg:text-[72px]",
  heading = "",
  headingStyle = "text-color-primary/60 text-[36px] font-tommaso lg:text-[48px] lg:max-w-[553px]",
  desktopDescription = "",
  description = [],
  descriptionStyle = "text-color-primary text-[16px] lg:text-[24px] lg:w-[928px]",
}) {
  return (
