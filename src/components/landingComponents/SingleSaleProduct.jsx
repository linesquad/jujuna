...
function SingleSaleProduct() {
  return (
    <div className="w-[300px]  pt-[4px] pb-[15px] px-[12px] relative">
      <div className="w-[120px] h-[175px] mx-auto">
        <img
          src={cocktail}
          alt="product"
      ...
      <p className="text-[20px] text-center mt-[20px]">ტვიში - თეთრი მშრალი</p>
      ...
      <div className="mt-[16px] flex items-center justify-between">
        <div className="flex flex-col gap-[8px]">
          <p className="text-[#008E28]">გაყიდვაშია</p>
          <p className="text-[22px]">45.00 ₾</p>
        </div>
      ...
      <div className="absolute top-0">
        <div className="relative">
          <FaStar size={70} color="#FC0909" />
          <p className="absolute top-[50%] translate-x-[-50%] left-[50%] translate-y-[-50%] text-[#fff] text-[20px]">
            50%
          </p>
        </div>
      </div>
