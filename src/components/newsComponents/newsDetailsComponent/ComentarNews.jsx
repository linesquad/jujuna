  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#A583D1] to-[#54436B] rounded">
      ...
      <div className="flex flex-col gap-3">
        <div className="tiny:pl-[11px] smaller:pl-[12px] pl-[13px] sm:pl-[18px] md:pl-[23px] lg:-[28px] flex items-center justify-between">
